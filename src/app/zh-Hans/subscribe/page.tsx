/**
 * @file 中文版邮件订阅落地页 (zh-Hans)
 * @description 用户可以订阅AI创业日报
 * @route /zh-Hans/subscribe
 */
  ...
  return (
    <div className="min-h-screen bg-[#0F1117] text-white overflow-x-hidden">
      ...
      <nav className="relative z-10 flex items-center justify-between px-6 md:px-12 py-5">
        <a href="/zh-Hans" className="flex items-center gap-3">
        ...
        <a href="/zh-Hans" className="text-sm text-slate-400 hover:text-white transition-colors">返回首页</a>
      </nav>
