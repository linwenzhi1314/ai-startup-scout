/**
 * @file 中文版邮件订阅落地页
 * @description 用户可以订阅AI创业日报，选择兴趣标签
 */
...
export default function SubscribePageZhHans() {
  ...
  return (
    <div className="min-h-screen bg-[#0F1117] text-white overflow-x-hidden">
      ...
      <nav className="relative z-10 flex items-center justify-between px-6 md:px-12 py-5">
        <Link href="/zh-Hans" className="flex items-center gap-3">
        ...
        <Link href="/zh-Hans" className="text-sm text-slate-400 hover:text-white transition-colors">返回首页</Link>
      </nav>
