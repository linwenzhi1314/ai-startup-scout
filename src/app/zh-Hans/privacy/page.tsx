...
export default function PrivacyPageZhHans() {
  return (
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <section className="mb-8">
          ...
          <p className="text-slate-300 leading-relaxed">
            ...
            <Link href="/zh-Hans/support" className="text-[#6366F1] hover:underline">
              Support &amp; Feedback
            </Link>{' '}
            page.
          </p>
        ...
        {/* 返回首页 */}
        <div className="mt-10 pt-6 border-t border-[#2D3348]">
          <Link href="/zh-Hans" className="text-[#6366F1] hover:underline text-sm">
            ← 返回首页
          </Link>
        </div>
      </div>
