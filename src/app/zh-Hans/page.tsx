/**
 * @file 中文版首页（简体中文）
 * @description AI Startup Scout 中文版落地页
 */
...
export default function HomeZhHans() {
  ...
  return (
    <div className="min-h-screen bg-[#0F1117] text-white overflow-x-hidden">
      ...
      <nav className="relative z-10 flex items-center justify-between px-6 md:px-12 py-5">
        <a href="/zh-Hans" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
      ...
      <footer className="relative z-10 border-t border-[#2D3348] px-6 md:px-12 py-8">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            <a href="/zh-Hans/support" className="text-sm text-slate-400 hover:text-white transition-colors">支持与反馈</a>
            <a href="/zh-Hans/privacy" className="text-sm text-slate-400 hover:text-white transition-colors">隐私政策</a>
          </div>
